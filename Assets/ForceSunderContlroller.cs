...
public class ForceSunderContlroller : MonoBehaviour
{
    ...
    {
        // ✅ここに攻撃処理追加可能
        targetEnemy.GetComponent<Enemy>().TakeDamage(Mathf.CeilToInt(BattleManager.Instance.Status.Attack*10 * BetManager.Instance.CurrentBet*BattleManager.Instance.Status.CriticalDamageRate), transform.position, false, true,
                0);
