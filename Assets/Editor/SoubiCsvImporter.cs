...
public static class SoubiCsvImporter
{
    private const string CSV_PATH = "Assets/Data/CSV/装備.csv";
    private const string ASSET_DIR = "Assets/Data/装備/";

    [MenuItem("Tools/Import Soubi CSV")]
    public static void Import()
    {
        // ===== フォルダ保証 =====
        EnsureFolder("Assets/Data");
        EnsureFolder("Assets/Data/装備");
        ...
        foreach (var line in lines.Skip(1))
        {
            ...
            SoubiData data =
                AssetDatabase.LoadAssetAtPath<SoubiData>(assetPath);

            if (data == null)
            {
                data = ScriptableObject.CreateInstance<SoubiData>();
                data.id = id;
        ...
        Debug.Log("Soubi CSV Import Completed");
    }
